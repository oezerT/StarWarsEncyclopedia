...
import com.example.starwarsencyclopedia.mockFilms
...
class FilmRemoteMediatorTest {
    private lateinit var categoryDao: FilmDao
    ...
    fun refreshLoadReturnsSuccessResultWhenMoreDataIsPresent() = runTest {
        ...
        val pagingState = PagingState<Int, FilmEntity>(
            pages = listOf(),
            anchorPosition = null,
