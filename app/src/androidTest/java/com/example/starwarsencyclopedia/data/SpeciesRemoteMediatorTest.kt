...
import com.example.starwarsencyclopedia.data.local.species.SpeciesDao
import com.example.starwarsencyclopedia.data.local.species.SpeciesEntity
import com.example.starwarsencyclopedia.mockSpecies
...
class SpeciesRemoteMediatorTest {
    private lateinit var categoryDao: SpeciesDao
    ...
    fun refreshLoadReturnsSuccessResultWhenMoreDataIsPresent() = runTest {
        ...
        mockApi.species = mockSpecies()

        val remoteMediator = SpeciesRemoteMediator(
            starWarsDb = mockDb,
            starWarsApi = mockApi,
        )
